...
import TwoColumnLayout from "../slideComponents/TwoColumnLayout";

function Slide3() {
    return (
        <>
            <Heading align="center">Titre main</Heading>
            <TwoColumnLayout 
                leftContent={
                <>
                    ...
                    <Image src="/favicon.svg" alt="Une image2" align="right" width="1/2" />
